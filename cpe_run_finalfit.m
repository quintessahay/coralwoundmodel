...
%{'s_c','k_m','k_{ma}','k_c'} - 1 2 4 14
x0=[km; kma; sc; kc];
[x,fval,exitflag,output]=cpe_main_finalfit(x0)
...
g=x;
par_vec = readmatrix('cpe_fit_041024.txt');
pars = [g(1); g(2); par_vec(3); g(3); par_vec(5:13); g(4); par_vec(15:17)];
writematrix(pars,'finalfit.txt')
save('finalfit.mat','fc','fc_circ','fc_lin','output','Rvec1','Rvec2','x','x0')
